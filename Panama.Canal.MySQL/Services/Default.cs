...
using Panama.Canal.MySQL.Processes;
using Panama.Models;

namespace Panama.Canal.MySQL.Services
{
    public class _Default : IService
    {
        ...
        public void Dispose()
        {
            ...
            {
                _disposed = true;
                _log.LogInformation("Shutting down the Panama.Canal.MySQL processing server...");
                _cts.Cancel();
            ...
            {
                _log.LogInformation("### Panama.Canal.MySQL Default Server shutdown!");
            }
        }
        ...
        public Task Start(CancellationToken cancellationToken)
        {
            ...
            _log.LogDebug("### Panama.Canal.MySQL Default Server is starting.");
