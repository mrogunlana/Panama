    ...
    public class PublishXMessagesEverySecond : IJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
             ...
             */
                ...
                {
                    // serialize content
                    var content = new StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(forecasts), Encoding.UTF8, "application/json");

                    client.DefaultRequestHeaders.Add("User-Agent", "Panama.Samples.TestConsole");

                    _log.LogDebug($"Publishing forecast(s) to: {url}.");
