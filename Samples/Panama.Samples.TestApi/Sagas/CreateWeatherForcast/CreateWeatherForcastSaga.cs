...
using Panama.Samples.TestApi.Sagas.CreateWeatherForcast.Events;
using Panama.Samples.TestApi.Sagas.CreateWeatherForcast.Exits;
...
namespace Panama.Samples.TestApi.Sagas.CreateWeatherForcast
{
